...
class MessageManagerTests : BaseTest() {
    ...
    fun testDelayedStartInvoked() {
        ...
        val messageManager = AccessUtils.getMessageManager()
        Assert.assertFalse(messageManager.hasDelayedStartOccurred())
        val handler = com.mparticle.internal.AccessUtils.getMessageHandler()
    ...
    private val messageManager: MessageManager
        private get() = AccessUtils.getMessageManager()
}