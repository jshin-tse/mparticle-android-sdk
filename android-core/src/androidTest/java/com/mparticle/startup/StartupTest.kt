...
class StartupTest : BaseStartupTest() {
    ...
    var identityMap: Map<MParticle.IdentityType, String> =
        object : HashMap<MParticle.IdentityType?, String?>() {
            init {
    ...
    override fun startup() {
        val options = MParticleOptions.builder(context)
            ...
            .identifyTask(BaseIdentityTask().addFailureListener(object : TaskFailureListener {
